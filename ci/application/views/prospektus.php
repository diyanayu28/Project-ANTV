...
<div id="isi">
    ...
    <div style="padding-bottom:25px;">
        ...
        <h1 class="judul">Prospektus</h1>
    </div>
        
    <div id="posting2">
        <div class="img">
          <a href="Hubungan Investor/Prospektus/Prospektus_IMC.pdf">
          	<img src="<?=base_url()?>images/Prospektus.png" width="180" height="254" />
          </a>
          <div class="desc">Prospektus MDIA</div>
        </div>
